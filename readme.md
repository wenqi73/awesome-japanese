# Awesome Japanese [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome)
...
- [Grammar Guide to Japanese](https://www.guidetojapanese.org/) - By Tae Kim (Note: Tae Kim also has a "Complete Guide to Japanese", which is a work in progress).
...
2. A summary of the guides is basically this: first, learn hiragana and katakana using the links in the Hiragana and Katakana section further down this page. The Tofugu links are a good starting place.
...
- Amazon :moneybag:
  - [Genki 1 Textbook](https://www.amazon.com/dp/4789014401)
  - [Genki 1 Workbook](https://www.amazon.com/dp/478901441X)
  - [Genki 2 Textbook](https://www.amazon.com/dp/4789014436)
  - [Genki 2 Workbook](https://www.amazon.com/dp/4789014444)
...
- Amazon :moneybag:
  - [Minna no Nihongo II](https://www.amazon.com/Minna-Nihongo-II-Main-Textbook/dp/4883196461/)
  - [Minna no Nihongo II Workbook](https://www.amazon.com/Nihongo-Shokyu-Workbook-Hyojun-Mondaishu/dp/4883196631/)
...
- Amazon :moneybag:
  - [Quartet 1 Textbook](https://www.amazon.com/dp/4789016951)
  - [Quartet 1 Workbook](https://www.amazon.com/dp/478901696X)
...
- [Erin's Challenge](https://www.erin.jpf.go.jp/en/) - Video based Japanese lessons :man:.
...
- [Anki](https://apps.ankiweb.net/) - Popular flashcard based software :iphone: :computer:.
  ...
  - [Japanese Core 2000/6000](https://docs.google.com/document/d/1zyyuiWkiz2IF2CCROeJebl8mgRdHBqNfS5D7MFjDTzE/edit) - :card_index: Popular Anki Japanese deck (Core 2k/6k).
...
- [jpdb](https://jpdb.io/) - Powerful Japanese dictionary and all-in-one learning system for kanji and vocabulary.
- [Japanese Number Converter](https://japanesenumberconverter.com) - Convert numbers between kanji, hiragana, and romaji.
...
- [Japanese Grammar Guide](https://www.guidetojapanese.org/learn/grammar) - By Tae Kim. A complete guide to Japanese grammar from knowing nothing to advanced topics.
  - [Supplement Grammar List](https://aryailia.blogspot.my/2017/05/supplements-to-tae-kims-guide-to.html) - Supplement by Araia to Tae Kim's guide, targeted towards intermediate and advanced learners.
...
- [Dictionary of Japanese Grammar](https://ankiweb.net/shared/info/843402109) - :card_index: The DoJG deck allows you to review the contents of the Dictionary of Japanese Grammar through Anki.
...
- [Japanese Folktales](http://www.e-hon.jp/ehon_jp/index1.htm) - Classic folktales with drawings and audio :jp:.
...
- [Discord](https://discord.com/) - Popular chatroom platform :iphone: :computer:.
  ...
  - [Reddit Masterlist](https://www.reddit.com/r/languagelearning/comments/5m5426/discord_language_learning_servers_masterlist/) - Masterlist of language-learning Discord servers; see the East Asian Languages section.
  - [TheMoeWay](https://discord.gg/nhqjydaR8j) - Highly active Discord chat server for immersion Japanese learners with immersion logs.
...
- News
  - [BBC News in Japanese](https://www.youtube.com/channel/UCCcey5CP5GDZeom987gqTdg) - Japanese-language news channel from the BBC.
  - [Asahi News](https://www.youtube.com/user/ANNnewsCH) - Japanese news channel from Asahi.
  ...
  - [日テレNEWS24](https://www.youtube.com/channel/UCuTAXTexrhetbOe3zgskJBQ) - Nippon TV's 24-hour news channel with live stream and latest videos.
  - [Weather News Live](https://www.youtube.com/watch?v=kfTq_A9nBM0) - 24/7 Japanese Weather Channel Live stream.
  - [NIKKEI News](https://www.youtube.com/user/TouchTheNIKKEI) - Business news channel from Nikkei.
  - [Yomiuri News](https://www.youtube.com/user/YomiuriShimbun) - News channel from Yomiuri Shimbun.
- Stream
  - [QVC Japan](https://qvc.jp/cont/live/Main?sc_initcmp=icpc_TOP_Left-Menu_005) - Live stream of the QVC shopping channel in Japan.
...
- Software
  ...
  - [Tagaini Jisho](https://www.tagaini.net/) - Open-source Japanese dictionary and kanji lookup tool for Windows, macOS, and Linux.
...
- Computer
  ...
  - [Google Japanese Input](https://www.google.co.jp/ime/) - Japanese IME available on Windows, Mac, and Android :computer: :iphone:.
...
- Web
  - [Kanigo](https://www.kanigo.ai) - Japanese video and sentence breakdown from YouTube, uploads, or pasted text.
